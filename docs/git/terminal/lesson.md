...
If you're on Windows, make sure that you've followed the instructions [here](https://syllabus.codeyourfuture.io/git/preparation) to get setup with WSL. Alternatively, these exercises can be completed using [Git Bash](https://gitforwindows.org/)
