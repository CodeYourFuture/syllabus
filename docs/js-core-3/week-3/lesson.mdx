...
console.log(`In the Simpsons family, ${dad} and ${mum} are the parents. ${son} is the son, ${daughter} is the daughter, and ${baby} is the baby.`)
```
...
let [london, birmingam, glasgow, manchester] = citiesByPopulation;
...
Complete all of the exercises found [here](https://repl.it/@ChrisOwen101/ArrayDestructuring)
